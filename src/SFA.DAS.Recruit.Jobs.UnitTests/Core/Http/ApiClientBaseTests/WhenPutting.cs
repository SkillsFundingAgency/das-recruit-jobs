...
public class WhenPutting
{
    ...
    public async Task Then_The_Request_Is_Made_Correctly()
    {
        ...
        // act
        await sut.PutAsync<NoResponse>(new GenericPutRequest("/api/foo"));
    ...
    public async Task Then_The_Request_Content_Is_Correct(NotificationEmail email)
    {
        ...
        // act
        await sut.PutAsync<NoResponse>(new GenericPutRequest("/api/foo", email));
    ...
    public async Task Then_The_Response_Is_Processed_Correctly(NotificationEmail email)
    {
        ...
        // act
        var result = await sut.PutAsync<NotificationEmail>(new GenericPutRequest("/api/foo"));
